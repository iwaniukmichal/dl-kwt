...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{BC-ResNet-3} - compact CNN and the main convolutional model.
    \item \textbf{MatchboxNet-3x1x64} - efficient 1D time-channel separable CNN baseline.
\end{enumerate}
